...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Tejaswini Galla </p>
    <p><strong>Email ID:</strong> tejaswinig37aiml@gmail.com </p>
    <p><strong>College Name:</strong> Ists women's engineering college </p>
    <p><strong>Branch/Specialization :</strong> Artificial Intelligence </p>
    <p><strong>College ID:</strong> 206W1A4322 </p>
</div>
...
<div align="left" style="margin: 20px; font-size: 16px;">
    <p><strong>Course Opted:</strong> G37-AI & ML </p>
...
<p><strong>Trainer Designation:</strong> Data Engineer-Celebal Technologies</p>
...
During this project, I learned the complete Machine Learning development lifecycle, including data preprocessing, feature engineering, model training, evaluation, and deployment. I gained hands-on experience with Python, Scikit-learn, XGBoost, and Streamlit, while strengthening my skills in problem-solving, documentation, and developing real-world predictive solutions.


<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project 1:</a></strong> AI-Driven Smart Occupancy Prediction </p>
...
<!-- Project 1 -->
<h3 id="project1">Project 1: AI-Driven Smart Occupancy Prediction</h3>
<p>
...
> Overall, the LST and SST sessions were a valuable learning experience. They helped me understand that technical knowledge alone is not enough for professional growth. Communication, confidence, adaptability, teamwork, and problem-solving skills are equally important for building a successful career.
